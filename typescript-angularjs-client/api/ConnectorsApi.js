...
var ConnectorsApi = /** @class */ (function () {
     ...
     */
    ConnectorsApi.prototype.connectConnector = function (connectorName, userId, extraHttpRequestParams) {
     ...
     * @param connectorName Options: facebook, fitbit, github, googlecalendar, googlefit, medhelper, mint, moodpanda, moodscope, myfitnesspal, mynetdiary, netatmo, rescuetime, runkeeper, slack, sleepcloud, slice, up, whatpulse, withings, worldweatheronline, foursquare, strava, gmail
     */
    ConnectorsApi.prototype.disconnectConnector = function (connectorName, extraHttpRequestParams) {
     ...
     */
    ConnectorsApi.prototype.getConnectors = function (clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    ConnectorsApi.prototype.getIntegrationJs = function (clientId, extraHttpRequestParams) {
     ...
     * @param userId User&#39;s id
     */
    ConnectorsApi.prototype.getMobileConnectPage = function (userId, extraHttpRequestParams) {
     ...
     * @param userId User&#39;s id
     */
    ConnectorsApi.prototype.updateConnector = function (connectorName, userId, extraHttpRequestParams) {
