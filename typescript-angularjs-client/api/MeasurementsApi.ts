...
export class MeasurementsApi {
     ...
     */
    public deleteMeasurement (body: models.MeasurementDelete, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CommonResponse> {
     ...
     */
    public getMeasurements (variableName?: string, sort?: string, limit?: number, offset?: number, variableCategoryName?: string, updatedAt?: string, userId?: number, sourceName?: string, connectorName?: string, value?: string, unitName?: string, earliestMeasurementTime?: string, latestMeasurementTime?: string, createdAt?: string, id?: number, groupingWidth?: number, groupingTimezone?: string, doNotProcess?: boolean, clientId?: string, doNotConvert?: boolean, minMaxFilter?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Measurement>> {
     ...
     * @param userId User&#39;s id
     */
    public measurementExportRequest (userId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<number> {
     ...
     * @param userId User&#39;s id
     */
    public postMeasurements (body: Array<models.MeasurementSet>, userId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.PostMeasurementsResponse> {
     ...
     */
    public updateMeasurement (body: models.MeasurementUpdate, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.CommonResponse> {
