...
var RemindersService = /** @class */ (function () {
    function RemindersService(httpClient, basePath, configuration) {
     ...
     */
    RemindersService.prototype.canConsumeForm = function (consumes) {
    ...
    RemindersService.prototype.deleteTrackingReminder = function (body, userId, observe, reportProgress) {
        ...
        return this.httpClient.delete(this.basePath + "/v3/trackingReminders/delete", {
    ...
    RemindersService.prototype.getTrackingReminderNotifications = function (sort, userId, createdAt, updatedAt, limit, offset, variableCategoryName, reminderTime, clientId, onlyPast, includeDeleted, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: new encoder_1.CustomHttpUrlEncodingCodec() });
        ...
        if (reminderTime !== undefined && reminderTime !== null) {
            queryParameters = queryParameters.set('reminderTime', reminderTime);
        }
        if (clientId !== undefined && clientId !== null) {
            queryParameters = queryParameters.set('clientId', clientId);
        }
        if (onlyPast !== undefined && onlyPast !== null) {
            queryParameters = queryParameters.set('onlyPast', onlyPast);
        }
        ...
        return this.httpClient.get(this.basePath + "/v3/trackingReminderNotifications", {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    RemindersService.prototype.getTrackingReminders = function (userId, variableCategoryName, createdAt, updatedAt, limit, offset, sort, clientId, appVersion, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: new encoder_1.CustomHttpUrlEncodingCodec() });
        if (userId !== undefined && userId !== null) {
        ...
        return this.httpClient.get(this.basePath + "/v3/trackingReminders", {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    RemindersService.prototype.postTrackingReminderNotifications = function (body, userId, clientId, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (body === null || body === undefined) {
        ...
        return this.httpClient.post(this.basePath + "/v3/trackingReminderNotifications", body, {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    RemindersService.prototype.postTrackingReminders = function (body, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (body === null || body === undefined) {
        ...
        return this.httpClient.post(this.basePath + "/v3/trackingReminders", body, {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
