...
export class AuthenticationApi {
     ...
     */
    public getAccessToken (grantType: string, code: string, responseType: string, scope: string, clientId?: string, clientSecret?: string, redirectUri?: string, state?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     * @param state An opaque string that is round-tripped in the protocol; that is to say, it is returned as a URI parameter in the Basic flow, and in the URI
     */
    public getOauthAuthorizationCode (responseType: string, scope: string, clientId?: string, clientSecret?: string, redirectUri?: string, state?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     */
    public postGoogleIdToken (extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
