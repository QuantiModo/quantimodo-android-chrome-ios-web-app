...
var SharesService = /** @class */ (function () {
    function SharesService(httpClient, basePath, configuration) {
     ...
     */
    SharesService.prototype.canConsumeForm = function (consumes) {
    ...
    SharesService.prototype.deleteShare = function (clientIdToRevoke, reason, observe, reportProgress) {
        ...
        if (clientIdToRevoke !== undefined && clientIdToRevoke !== null) {
            queryParameters = queryParameters.set('clientIdToRevoke', clientIdToRevoke);
        }
        ...
        return this.httpClient.post(this.basePath + "/v3/shares/delete", null, {
    ...
    SharesService.prototype.getShares = function (userId, createdAt, updatedAt, clientId, appVersion, log, pwd, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: new encoder_1.CustomHttpUrlEncodingCodec() });
        ...
        return this.httpClient.get(this.basePath + "/v3/shares", {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    SharesService.prototype.inviteShare = function (body, clientId, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        return this.httpClient.post(this.basePath + "/v3/shares/invite", body, {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
