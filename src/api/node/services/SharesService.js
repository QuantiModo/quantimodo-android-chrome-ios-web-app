...
var SharesService = /** @class */ (function () {
     ...
     * @throws ApiError
     */
    SharesService.getShares = function (userId, createdAt, updatedAt, clientId, appVersion, log, pwd) {
     ...
     * @throws ApiError
     */
    SharesService.deleteShare = function (clientIdToRevoke, reason) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @throws ApiError
     */
    SharesService.inviteShare = function (requestBody, clientId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
//# sourceMappingURL=SharesService.js.map