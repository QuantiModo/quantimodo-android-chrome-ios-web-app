...
var FriendsService = /** @class */ (function () {
     ...
     * @throws ApiError
     */
    FriendsService.getFriends = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId) {
     ...
     * @throws ApiError
     */
    FriendsService.postFriends = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId) {
        if (limit === void 0) { limit = 100; }
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
