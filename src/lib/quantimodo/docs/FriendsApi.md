# Quantimodo.FriendsApi

All URIs are relative to *https://app.quantimo.do/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getFriends**](FriendsApi.md#getFriends) | **GET** /v3/friends | Get Friends
[**postFriends**](FriendsApi.md#postFriends) | **POST** /v3/friends | Post Friends


<a name="getFriends"></a>
# **getFriends**
> [FriendsResponse] getFriends(opts)
...
var apiInstance = new Quantimodo.FriendsApi();
...
apiInstance.getFriends(opts, callback);
```
...
<a name="postFriends"></a>
# **postFriends**
> [FriendsResponse] postFriends(opts)
...
apiInstance.postFriends(opts, callback);
```
