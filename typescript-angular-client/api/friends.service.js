...
var FriendsService = /** @class */ (function () {
    function FriendsService(httpClient, basePath, configuration) {
     ...
     */
    FriendsService.prototype.canConsumeForm = function (consumes) {
    ...
    FriendsService.prototype.getFriends = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, observe, reportProgress) {
        ...
        return this.httpClient.get(this.basePath + "/v3/friends", {
    ...
    FriendsService.prototype.postFriends = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: new encoder_1.CustomHttpUrlEncodingCodec() });
        if (sort !== undefined && sort !== null) {
        ...
        return this.httpClient.post(this.basePath + "/v3/friends", null, {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
