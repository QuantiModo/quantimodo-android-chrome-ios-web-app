...
export class NotificationsService {
     ...
     * @throws ApiError
     */
    static async postDeviceToken(requestBody) {
     ...
     * @throws ApiError
     */
    static async getFeed(sort, userId, createdAt, updatedAt, limit = 100, offset, clientId) {
        const result = await __request({
            method: 'GET',
            path: `/v3/feed`,
            query: {
     ...
     * @throws ApiError
     */
    static async postFeed(requestBody, userId, clientId) {
        const result = await __request({
            method: 'POST',
            path: `/v3/feed`,
            query: {
     ...
     * @throws ApiError
     */
    static async getNotifications(sort, limit = 100, offset, updatedAt, userId, createdAt, id, clientId) {
        const result = await __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static async postNotifications(sort, limit = 100, offset, updatedAt, userId, createdAt, id, clientId) {
        const result = await __request({
            method: 'POST',
            path: `/v3/notifications`,
            query: {
