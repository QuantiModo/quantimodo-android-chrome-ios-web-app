angular.module('starter').controller('FavoritesCtrl', function($scope, $state, $ionicActionSheet, $timeout, qmService, qmLog, $rootScope,
										  $stateParams) {
    ...
    $scope.refreshFavorites = function () {
        qmLog.debug("ReminderMange init: calling refreshTrackingRemindersAndScheduleAlarms");
