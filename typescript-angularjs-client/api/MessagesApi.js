...
var MessagesApi = /** @class */ (function () {
    function MessagesApi($http, $httpParamSerializer, basePath) {
        this.$http = $http;
     ...
     */
    MessagesApi.prototype.getMessagesMessages = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    MessagesApi.prototype.getMessagesNotices = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    MessagesApi.prototype.getMessagesRecipients = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    MessagesApi.prototype.postMessagesMessages = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/v3/messagesMessages';
        var queryParameters = {};
        var headerParams = Object.assign({}, this.defaultHeaders);
        if (sort !== undefined) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    MessagesApi.prototype.postMessagesNotices = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/v3/messagesNotices';
        var queryParameters = {};
        var headerParams = Object.assign({}, this.defaultHeaders);
        if (sort !== undefined) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    MessagesApi.prototype.postMessagesRecipients = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/v3/messagesRecipients';
        var queryParameters = {};
        var headerParams = Object.assign({}, this.defaultHeaders);
        if (sort !== undefined) {
    ...
    MessagesApi.$inject = ['$http', '$httpParamSerializer', 'basePath'];
    return MessagesApi;
}());
