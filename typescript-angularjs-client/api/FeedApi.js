...
var FeedApi = /** @class */ (function () {
    function FeedApi($http, $httpParamSerializer, basePath) {
        this.$http = $http;
     ...
     */
    FeedApi.prototype.getFeed = function (sort, userId, createdAt, updatedAt, limit, offset, clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    FeedApi.prototype.postFeed = function (body, userId, clientId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/v3/feed';
        var queryParameters = {};
        var headerParams = Object.assign({}, this.defaultHeaders);
    ...
    FeedApi.$inject = ['$http', '$httpParamSerializer', 'basePath'];
    return FeedApi;
}());
