...
export class FriendsApi {
     ...
     */
    public getFriends (sort?: string, limit?: number, offset?: number, updatedAt?: string, userId?: number, createdAt?: string, id?: number, clientId?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.FriendsResponse>> {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    public postFriends (sort?: string, limit?: number, offset?: number, updatedAt?: string, userId?: number, createdAt?: string, id?: number, clientId?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.FriendsResponse>> {
        const localVarPath = this.basePath + '/v3/friends';
