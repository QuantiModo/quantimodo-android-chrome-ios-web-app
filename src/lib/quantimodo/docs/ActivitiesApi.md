...
# **getActivities**
> [ActivitiesResponse] getActivities(opts)
...
var apiInstance = new Quantimodo.ActivitiesApi();
...
# **postActivities**
> [ActivitiesResponse] postActivities(opts)
...
apiInstance.postActivities(opts, callback);
```
