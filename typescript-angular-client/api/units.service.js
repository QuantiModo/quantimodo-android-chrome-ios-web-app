...
var UnitsService = /** @class */ (function () {
    function UnitsService(httpClient, basePath, configuration) {
     ...
     */
    UnitsService.prototype.canConsumeForm = function (consumes) {
    ...
    UnitsService.prototype.getUnitCategories = function (observe, reportProgress) {
        ...
        return this.httpClient.get(this.basePath + "/v3/unitCategories", {
    ...
    UnitsService.prototype.getUnits = function (observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: new encoder_1.CustomHttpUrlEncodingCodec() });
        var headers = this.defaultHeaders;
        ...
        return this.httpClient.get(this.basePath + "/v3/units", {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
