...
import type { GetStudiesResponse } from '../models/GetStudiesResponse';
import type { PostStudyCreateResponse } from '../models/PostStudyCreateResponse';
import type { PostStudyPublishResponse } from '../models/PostStudyPublishResponse';
import type { Study } from '../models/Study';
import type { StudyCreationBody } from '../models/StudyCreationBody';
import type { StudyJoinResponse } from '../models/StudyJoinResponse';
...
downvoted?: boolean,
     ...
     * @throws ApiError
     */
    public static async getOpenStudies(
outcomeVariableName?: string,
causeVariableName?: string,
causeVariableId?: number,
effectVariableId?: number,
...
studyId?: string,
     ...
     * @throws ApiError
     */
    public static async getStudiesJoined(
limit: number = 100,
causeVariableName?: string,
causeVariableId?: number,
effectVariableId?: number,
...
clientId?: string,
     ...
     * @throws ApiError
     */
    public static async getStudiesCreated(
sort?: string,
causeVariableName?: string,
causeVariableId?: number,
effectVariableId?: number,
...
clientId?: string,
     ...
     * @throws ApiError
     */
    public static async publishStudy(
outcomeVariableName?: string,
causeVariableName?: string,
causeVariableId?: number,
effectVariableId?: number,
...
recalculate?: boolean,
studyId?: string,
): Promise<PostStudyPublishResponse> {
        const result = await __request({
            method: 'POST',
...
requestBody: StudyCreationBody,
clientId?: string,
): Promise<PostStudyCreateResponse> {
        const result = await __request({
            method: 'POST',
...
userId?: number,
     ...
     * @throws ApiError
     */
    public static async deleteVote(
userId?: number,
): Promise<void> {
        const result = await __request({
            method: 'DELETE',
