...
export class AnalyticsService {
     ...
     * @throws ApiError
     */
    static async getCorrelations(limit = 100, causeVariableName, causeVariableId, effectVariableId, predictorVariableName, outcomeVariableName, sort, effectVariableName, offset, userId, correlationCoefficient, updatedAt, outcomesOfInterest, clientId, commonOnly) {
     ...
     * @throws ApiError
     */
    static async getCorrelationExplanations(causeVariableName, effectVariableName, causeVariableId, effectVariableId, predictorVariableName, outcomeVariableName) {
        const result = await __request({
            method: 'GET',
