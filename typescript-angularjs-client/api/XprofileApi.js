...
var XprofileApi = /** @class */ (function () {
    function XprofileApi($http, $httpParamSerializer, basePath) {
        this.$http = $http;
     ...
     */
    XprofileApi.prototype.getXprofileData = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    XprofileApi.prototype.getXprofileFields = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    XprofileApi.prototype.getXprofileGroups = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    XprofileApi.prototype.postXprofileData = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/v3/xprofileData';
        var queryParameters = {};
        var headerParams = Object.assign({}, this.defaultHeaders);
        if (sort !== undefined) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    XprofileApi.prototype.postXprofileFields = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/v3/xprofileFields';
        var queryParameters = {};
        var headerParams = Object.assign({}, this.defaultHeaders);
        if (sort !== undefined) {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    XprofileApi.prototype.postXprofileGroups = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/v3/xprofileGroups';
        var queryParameters = {};
        var headerParams = Object.assign({}, this.defaultHeaders);
        if (sort !== undefined) {
    ...
    XprofileApi.$inject = ['$http', '$httpParamSerializer', 'basePath'];
    return XprofileApi;
}());
exports.XprofileApi = XprofileApi;
//# sourceMappingURL=XprofileApi.js.map