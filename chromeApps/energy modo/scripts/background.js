chrome.app.runtime.onLaunched.addListener(function() {
  ...
  chrome.app.window.create('www/index.html?app=energymodo', {
    innerBounds: {
      width: 476,
      height: 603
    }
...
chrome.alarms.onAlarm.addListener(function(alarm)
{
    console.log('alarms triggered');
        ...
        var notificationParams = {
            type: "basic",
            title: "How energetic are you?",
            message: "It's time to report your energy level!",
...
chrome.notifications.onClicked.addListener(function(notificationId)
{
    if(notificationId == "trackReportNotification")
    {
       /* var windowParams = {url: "www/templates/popup.html",
        ...
        chrome.app.window.create('templates/popup.html', {
            innerBounds: {
                width: 376,
                height: 60
            },
