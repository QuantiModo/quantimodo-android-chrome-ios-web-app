...
1. Run `gulp generateXmlConfigAndUpdateAppsJs`
...
1. `gulp generateXmlConfigAndUpdateAppsJs`. This will copy your generated xml config file (apps/[your_app_code_name_here]/config.xml) into the main config.xml so that the iOS app is generated with your new app as default.
