...
export class ConnectorsService {
     ...
     * @throws ApiError
     */
    static async getMobileConnectPage(userId) {
     ...
     * @throws ApiError
     */
    static async getConnectors(clientId) {
        const result = await __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static async connectConnector(connectorName, userId) {
        const result = await __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static async disconnectConnector(connectorName) {
        const result = await __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static async updateConnector(connectorName, userId) {
        const result = await __request({
            method: 'GET',
 ...
 * If using in a Cordova application call  `qmSetupOnIonic` function after connecting `connect.js`.
     ...
     * @throws ApiError
     */
    static async getIntegrationJs(clientId) {
        const result = await __request({
            method: 'GET',
