...
var apiInstance = new Quantimodo.GroupsApi();
...
<a name="getGroupsMembers"></a>
# **getGroupsMembers**
> [GroupsMembersResponse] getGroupsMembers(opts)
...
apiInstance.getGroupsMembers(opts, callback);
```
...
[**[GroupsMembersResponse]**](GroupsMembersResponse.md)
...
<a name="postGroups"></a>
# **postGroups**
> [GroupsResponse] postGroups(opts)
...
apiInstance.postGroups(opts, callback);
```
...
<a name="postGroupsMembers"></a>
# **postGroupsMembers**
> [GroupsMembersResponse] postGroupsMembers(opts)
...
apiInstance.postGroupsMembers(opts, callback);
```
