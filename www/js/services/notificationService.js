angular.module('starter')
    .factory('notificationService',function($rootScope, $ionicPlatform, $state, $q, QuantiModo, timeService,
        ...
        notificationService.updateBadgesAndTextOnAllNotifications = function () {
            if(!notificationService.shouldWeUseIonicLocalNotifications()) {
                return;
            }
        ...
        notificationService.setOnTriggerAction = function() {
            if(!notificationService.shouldWeUseIonicLocalNotifications()) {
                return;
            }
        ...
        notificationService.setNotificationBadge = function(numberOfPendingNotifications){
        ...
        notificationService.updateOrRecreateNotifications = function() {
            if(!notificationService.shouldWeUseIonicLocalNotifications()) {
                return;
            }
        ...
        notificationService.cancelNotificationsForDeletedReminders = function(trackingRemindersFromApi) {
        ...
        notificationService.scheduleGenericNotification = function(notificationSettings){
        ...
        notificationService.cancelIonicNotificationById = function(notificationId){
            if(!notificationService.shouldWeUseIonicLocalNotifications()) {
                return;
            }
            $ionicPlatform.ready(function () {
        ...
        notificationService.scheduleUpdateOrDeleteGenericNotificationsByDailyReminderTimes = function(trackingReminders){
            if(!notificationService.shouldWeUseIonicLocalNotifications()) {
                return;
            }
