...
export class ActivitiesApi {
     ...
     */
    public getActivities (sort?: string, limit?: number, offset?: number, updatedAt?: string, userId?: number, createdAt?: string, id?: number, clientId?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ActivitiesResponse>> {
     ...
     * @param clientId Your QuantiModo client id can be obtained by creating an app at https://builder.quantimo.do
     */
    public postActivities (sort?: string, limit?: number, offset?: number, updatedAt?: string, userId?: number, createdAt?: string, id?: number, clientId?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ActivitiesResponse>> {
        const localVarPath = this.basePath + '/v3/activities';
