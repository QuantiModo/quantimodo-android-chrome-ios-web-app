...
/* tslint:disable */
/* eslint-disable */
import type { GetSharesResponse } from '../models/GetSharesResponse';
import type { ShareInvitationBody } from '../models/ShareInvitationBody';
...
pwd?: string,
     ...
     * @throws ApiError
     */
    public static async deleteShare(
...
reason?: string,
     ...
     * @throws ApiError
     */
    public static async inviteShare(
requestBody: ShareInvitationBody,
clientId?: string,
): Promise<void> {
        const result = await __request({
            method: 'POST',
