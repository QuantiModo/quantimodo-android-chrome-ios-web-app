...
if [ -z ${BUDDYBUILD_SCHEME} ];
    then
        ...
        unzip ${BUDDYBUILD_WORKSPACE}/platforms/android/build/outputs/apk/android-armv7-release.apk
        ...
        unzip ${BUDDYBUILD_WORKSPACE}/platforms/android/build/outputs/apk/android-x86-release.apk
        keytool -printcert -file META-INF/CERT.RSA
