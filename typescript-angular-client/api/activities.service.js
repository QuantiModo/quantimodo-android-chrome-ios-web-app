...
var ActivitiesService = /** @class */ (function () {
    ...
    ActivitiesService.prototype.getActivities = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, observe, reportProgress) {
        ...
        return this.httpClient.get(this.basePath + "/v3/activities", {
    ...
    ActivitiesService.prototype.postActivities = function (sort, limit, offset, updatedAt, userId, createdAt, id, clientId, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: new encoder_1.CustomHttpUrlEncodingCodec() });
        if (sort !== undefined && sort !== null) {
        ...
        return this.httpClient.post(this.basePath + "/v3/activities", null, {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
